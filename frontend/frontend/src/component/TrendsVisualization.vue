  ...
  <div class="trends-container bg-container">
    ...
    <div class="main-layout">
      ...
      <div class="right-panel">
        ...
        <!-- Bottom bleaching comparison chart -->
    <div class="bleaching-gallery">
          <div class="bleaching-item">
            <img src="../assets/bleach 20%.png" alt="20% Bleaching" class="bleaching-image" />
        <div class="bleaching-label">20%</div>
        <div class="bleaching-desc">Mild bleaching, most corals remain healthy and active.</div>
          </div>

          <div class="bleaching-item">
            <img src="../assets/bleach 40%.png" alt="40% Bleaching" class="bleaching-image" />
        ...
        <div class="bleaching-desc">Moderate bleaching, some corals lose symbiotic algae and face increasing stress.</div>
          ...
          <div class="bleaching-item">
            <img src="../assets/bleach 60%.png" alt="60% Bleaching" class="bleaching-image" />
...
export default {
  ...
  data() {
    return {
      ...
      markerLayers: [],
      selectedMarker: null,
      // Merged search box related data
      showDropdown: false,
      highlightedIndex: -1,
      isActivelySearching: false, // Mark whether user is actively searching
      // Comparison function related data
      showCompareModal: false,
      selectedCompareIslands: ['', '', '', ''], // 4 dropdown selections, array index corresponds to column
      // Summary modal
      ...
      compareColumns: [1, 2, 3, 4], // 4 column layout
      compareChart: null,
      compareData: {},
      // Chart data
      chartData: {
  ...
  computed: {
    ...
    filteredIslands() {
      // If user is not actively searching (just selected state), show all islands
      if (!this.isActivelySearching) {
        return this.availableIslands;
      }
      
      // User is actively searching, filter based on input content
  ...
  async mounted() {
    ...
    // Execute initialization and data loading in parallel
    await Promise.all([
      this.$nextTick(() => {
        this.setupChart();
