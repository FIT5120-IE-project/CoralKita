  ...
  <div class="main-container">
    ...
    <div class="scroll-content">
        ...
        <div class="status-section top-section">
          <div class="section-content">
            <div class="image-container">
              <img src="@/assets/mainpage_healthyCoral.webp" alt="Colorful Coral Reef" class="status-image" />
            </div>
      ...
      <div class="scroll-arrow arrow-1" @click="scrollToSection('middle-section')">
        <img src="@/assets/icons/arrow.png" alt="Scroll Down" class="arrow-icon" />
      </div>
        ...
        <div id="middle-section" class="status-section middle-section">
          <div class="section-content">
            ...
            <div class="image-container">
              <img src="@/assets/mainpage_bleading.webp" alt="Bleaching Coral" class="status-image" />
            </div>
          </div>
        </div>
...
.main-container {
  ...
  padding-bottom: 200px; /* 确保底部有足够空间，防止截断 */
}
...
.main-container::after {
  ...
  background-image: url('@/assets/bg_mainpage.webp');
